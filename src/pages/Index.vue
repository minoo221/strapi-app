<template>
  <Layout>
    <div class="container">
      ...
      <h2 class="text-2xl uppercase text-gray-600 mb-6 mt-16 tracking-wide font-semibold">
        My latest projects
      </h2>
    </div>
    <!-- List of project preview cards -->
    <div class="flex flex-col gap-12">
      <ProjectCard v-for="project in $page.strapi.projects" :key="project.id" :project="project" />
    </div>
  </Layout>
</template>
